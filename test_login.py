...
@allure.story(
    "TC_005.03 | Система выводит сообщение о пустом поле при вводе пустого Email."
)
...
@allure.story(
    "TC_005.04 | Пользователь может авторизоваться по валиднму Логину и валидному паролю."
)
